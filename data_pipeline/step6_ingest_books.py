...
BOOK_CATALOGUE = {
    ...
    # New PDFs from user
    "class9.pdf":                           {"name": "Class 9 Textbook",                           "type": "school",        "use": "pretrain"},
    "class11.pdf":                          {"name": "Class 11 Textbook",                          "type": "school",        "use": "pretrain"},
    "Agricultural-Business-Management.pdf": {"name": "Agricultural Business Management",           "type": "agribusiness",  "use": "pretrain"},
    "Field-Crop-Kharif.pdf":                {"name": "Field Crop Kharif",                          "type": "crop_science",  "use": "both"},
    "Introduction-to-Soil-Science.pdf":     {"name": "Introduction to Soil Science",               "type": "soil_science",  "use": "pretrain"},
    ...
    "Irrigation-Engineering.pdf":           {"name": "Irrigation Engineering",                     "type": "irrigation",    "use": "pretrain"},
